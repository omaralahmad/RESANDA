...
--------------------------------
 if matches[1]:lower() == "photo" then 
  ...
  tdcli.sendPhoto(msg.to.id, 0, 0, 1, nil, file, "تابع قناة السورس @dev_evo 🌍📮", dl_cb, nil)
 end
...
if not lang then
helpfun = [[
اهلا بك في قائمة الاوامر الملحقة
...
_لتحويل الكلام الى صوت_



*!sticker* `[word]`

_تبديل الكلام الى ملسق_



*!photo* `[word]`

_تبديل الكلام الى صورة_
...
_للحساب وجميع عمليات الطرح والجمع_



*!praytime* `[city]`

_لمعرفة الوقت التابع لمدينتك_



*!tosticker* `[reply]`

_تبديل الصورة الى ملسق_
